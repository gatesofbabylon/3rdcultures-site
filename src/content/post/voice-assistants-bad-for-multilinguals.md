---
cover: /images/posts/voice-assistants-bad-for-multilinguals/Screen+Shot+2020-10-14+at+14.49.02.png
description: 'Or: how Google only fulfils half of its mission.'
draft: false
...
I’m sure there are memes out there, about how monolingual people often don’t realise how rarely languages map to each other cleanly, in a 1:1 sense. ([truth in tweet form](https://twitter.com/dwvcd/status/1340554964293222400?s=20))
...
There was an IME (software keyboard) for iOS that would detect your typing language automatically as you typed. It would only do that between languages that used the alphabet, so it wouldn’t work between English and Japanese, but it’s a start. We need a voice-assistant version of that, basically. (EDIT: iOS seems to do a version of that [in speech-to-text dictation](https://www.macworld.com/article/3403455/whats-new-with-the-keyboard-in-ios-13-and-ipados-13.html), which is at least a step in the right direction)
